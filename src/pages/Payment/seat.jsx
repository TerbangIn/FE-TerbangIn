...
`;
  ...
  return (
    <>
      <style>{style}</style>
        <div className="bg-green w-97 h-10">
            <h1 className="text-sm text-white text-center pt-2.5">Economy - 64 Seats Available</h1>
            <div className="seat-picker">
                <div className="flex flex-row space-x-9 ml-31" >
                    ...
                    <p className="mb-0 ms-2 me-5" style={{ color: "#8A8A8A" }}>
                        C
                    </p>
                    <p className="mb-0 ms-2 me-4" style={{ color: "#8A8A8A" }}>
                        D
                    </p>
                    <p className="mb-0 ms-1 me-4" style={{ color: "#8A8A8A" }}>
                        E
                    </p>
                    <p className="mb-0 ms-2" style={{ color: "#8A8A8A" }}>
                        F
                    </p>
                </div>
                <div className="seat-grid ml-25">
                    <label className={`text-white-50 seats ${selectedSeats.includes("A1") ? "selected" : ""}`} style={{ cursor: "not-allowed" }}>
                        <input type="checkbox" value="A1" checked={selectedSeats.includes("A1")} onChange={() => handleSeatSelect("A1")} hidden disabled />X
                    </label>
                    <label className={`text-white-50 seats ${selectedSeats.includes("B1") ? "selected" : ""}`} style={{ cursor: "not-allowed" }}>
                        <input type="checkbox" value="B1" checked={selectedSeats.includes("B1")} onChange={() => handleSeatSelect("B1")} hidden disabled />X
                    </label>
                    <label className={`text-white-50 seats ${selectedSeats.includes("C1") ? "selected" : ""}`} style={{ cursor: "not-allowed" }}>
                    ...
                    <label
                        className={`text-white-50 seats ${selectedSeats.includes("D1") ? "selected" : ""}`} style={{ cursor: selectedSeats.includes("D1") ? "not-allowed" : "pointer" }}
                    >
