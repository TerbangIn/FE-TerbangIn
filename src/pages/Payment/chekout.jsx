...
function Checkout() {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwiZW1haWwiOiJ6b2RwbHVnaW5AZ21haWwuY29tIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNjg3NDczNjg2fQ.z3GkHhcIxEkg-VhrFPQ7JIFtrp17j-Z9qIr8nC-bxJI";
    function submit(e) {
        e.preventDefault();
        Axios.post(url, {
            title: data.title,
